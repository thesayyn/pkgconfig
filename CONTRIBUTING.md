...
some other ruleset that depends on pkgconfig, or in a nested
...
```sh
OVERRIDE="--override_repository=pkgconfig=$(pwd)/pkgconfig"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@pkgconfig` on your system will point to this folder.
...
https://github.com/thesayyn/pkgconfig/actions/workflows/tag.yaml
